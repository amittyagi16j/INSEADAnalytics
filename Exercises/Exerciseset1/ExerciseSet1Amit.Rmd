...
dataset1.R mytickers = c("SPY", "AAPL")
...
Yes it is possible by obtaining Stock Returns of Yahoo in dataset.R and then using the above commands as in the case ofApple.
<br>
<br>
...
nrow(transposeData) and ncol(transposeData)
...
Need to change start date in dataset.R

Question 2.

Change the line mytickers = c("SPY", "AAPL") to get returns
<br>
<br>
<br>
